$migrationPath = "c:\AEU\Year4 AEU2025\semester 2\4_IOS App Development\backend\database\migrations\2026_03_05_132504_create_notifications_table.php"
...
Set-Content -Path $migrationPath -Value $content -Encoding UTF8
Write-Host "Migration file updated successfully!"
